...
declare -a themes=("scalewayLight" "scalewayDark" "scalewayDarker")

# This function will get JSON, parse it with jq and create all necessary tokens
function generateTokens {
  THEME=$1
  GLOBAL=$2
  JSON=$(cat "./scripts/test.json")
 ...
 */
export const TestTheme = "; echo "${FINAL_RESULT}") > packages/themes/src/themes/console/"${i}".ts
